namespace AspNet.Mvc.TypedRouting.Test.LinkGeneration
{
	...
	public class ControllerExtensionsTest : ICollectionFixture<WebApplicationFactory<TestStartup>>
	{
		private readonly WebApplicationFactory<TestStartup> _factory;

		public ControllerExtensionsTest(WebApplicationFactory<TestStartup> factory)
		{
			_factory = factory;
		}
